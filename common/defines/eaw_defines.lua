...
NDefines.NDiplomacy.TENSION_TIME_SCALE_START_DATE = "1048.1.1.12"
...
NDefines.NAI.DEPLOY_MIN_TRAINING_WAR_FACTOR = 0.5	--default 0.95	-- Required percentage of training (1.0 = 100%) for AI to deploy unit in wartime
